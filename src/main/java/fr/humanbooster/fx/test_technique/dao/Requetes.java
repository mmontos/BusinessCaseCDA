...
public class Requetes {
	...
	public static final String QUESTION_PAR_ID = "SELECT idQUESTION, enonce, lienMedia, estChoixMultiples, estEliminatoire, idUTILISATEUR, idQUESTIONNAIRE, idDOMAINE, idNIVEAU FROM question WHERE idQUESTION=?";
	public static final String TOUTES_LES_QUESTIONS = "SELECT idQUESTION, enonce, lienMedia, estChoixMultiples, estEliminatoire, idUTILISATEUR, idQUESTIONNAIRE, idDOMAINE, idNIVEAU FROM question";
	public static final String QUESTION_PAR_idUTILISATEUR = "SELECT idQUESTION, enonce, lienMedia, estChoixMultiples, estEliminatoire, idUTILISATEUR, idQUESTIONNAIRE, idDOMAINE, idNIVEAU FROM question WHERE idUTILISATEUR=?";
	public static final String QUESTION_PAR_idQUESTIONNAIRE_ET_idDOMAINE = "SELECT idQUESTION, enonce, lienMedia, estChoixMultiples, estEliminatoire, idUTILISATEUR, idQUESTIONNAIRE, idDOMAINE, idNIVEAU FROM question WHERE idQUESTIONNAIRE=? AND idDOMAINE=?";
